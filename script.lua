...
title2.Text = "https://discord.gg/JGw8K2dK3Z"
...
local function EKBNYI_fake_script() -- Auto Durability.LocalScript 
	...
	script.Parent.MouseButton1Down:Connect(function()
       ...
       Infinite.Text = "Auto Durability (Active)"
       script.Parent.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
       script.Parent.Size = UDim2.new(0, 155, 0, 55)
       script.Parent.TextColor3 = Color3.fromRGB(0,0,0)
       wait(.1)
       ...
       while wait() do
          if click ~= 2 then
              local ohString1 = "rep"
              local ohInstance2 = workspace.machinesFolder["Bench Press"].interactSeat
              game:GetService("Players").LocalPlayer.muscleEvent:FireServer(ohString1, ohInstance2)
          else
          Infinite.Text = "Auto Durability"
          end
...
local function EKBDAEKDI_fake_script() -- autoPunch.LocalScript 
	...
	script.Parent.MouseButton1Down:Connect(function()
       ...
       while wait() do
           if click ~= 2 then
                ...
                local ohString2 = "leftHand"
                local ohString3 = "rightHand"
                game:GetService("Players").LocalPlayer.muscleEvent:FireServer(ohString1, ohString2)
                wait(.1)
                game:GetService("Players").LocalPlayer.muscleEvent:FireServer(ohString1, ohString3)
           else
            Invis.Text = "Auto Punch"
           end
